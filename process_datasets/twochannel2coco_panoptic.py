...
python process_datasets/twochannel2coco_panoptic.py \
    --source_folder datasets/MedicalDatasets/MoNuSeg/test/panoptic_seg_anns \
    --images_json_file datasets/MedicalDatasets/MoNuSeg/test/panoptic_anns.json \
    --segmentations_folder datasets/MedicalDatasets/MoNuSeg/test/panoptic_seg_anns_coco \
    --predictions_json_file datasets/MedicalDatasets/MoNuSeg/test/panoptic_anns_coco.json

python process_datasets/twochannel2coco_panoptic.py \
    --source_folder datasets/MedicalDatasets/PanNuke/Part3/panoptic_binary_seg_anns \
    --images_json_file datasets/MedicalDatasets/PanNuke/Part3/panoptic_binary_anns.json \
    --segmentations_folder datasets/MedicalDatasets/PanNuke/Part3/panoptic_binary_seg_anns_coco \
    --predictions_json_file datasets/MedicalDatasets/PanNuke/Part3/panoptic_binary_anns_coco.json
'''