...
seed = 1234
device = 'cuda:0'
dataset_config_file = 'densesam/configs/datasets/conic.py'
sam_ckpt_path = 'checkpoints_sam/sam_vit_h_4b8939.pth'
save_inners = [1]
    ...
    for dataloader in [train_dataloader, val_dataloader]:
        for i_batch, sampled_batch in enumerate(tqdm(dataloader, ncols=70)):
            ...
            for datainfo, img_t, img_t_in in zip(sampled_batch['data_samples'], bs_image_embedding, bs_inner_feats):
                # datasets/MedicalDatasets/MoNuSeg/train/img_dir/TCGA-G9-6356-01Z-00-DX1.png
