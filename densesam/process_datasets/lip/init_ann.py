...
categories_info = [
    ...
    {'id': FOREGROUND_ID, 'name': 'human', 'isthing': 1, 'color':palette[1], 'supercategory': '' }
]
...
def create_coco_init():
    ...
    for mode in modes:
        ...
        for filename in tqdm(all_imgs):
            ...
            mask_path = f'{mask_img_dir}/{filename}'.replace('.jpg','.png')
            ...
            panoptic_ann[image_mask > 0] = [FOREGROUND_ID, 1, 0]
